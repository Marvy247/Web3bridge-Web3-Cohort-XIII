...
export interface DudenNFTInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "TOKEN_URI"
      | "approve"
...
export interface DudenNFT extends BaseContract {
  connect(runner?: ContractRunner | null): DudenNFT;
  waitForDeployment(): Promise<this>;

  interface: DudenNFTInterface;
  ...
  mintMultipleNFTs: TypedContractMethod<
  ...
  >;
  getFunction(
    nameOrSignature: "mintMultipleNFTs"
  ): TypedContractMethod<
    [to: AddressLike, amount: BigNumberish],
    [void],
    "nonpayable"
